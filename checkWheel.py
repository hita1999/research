...
def searchWheel(cycleList, graph, w, n):
    ...
    print("size:",sys.getsizeof(cycleList))
    ...
    print("vertex_cycleList:",vertex_cycleList)
...
def main():
    ...
    #p = Pool(1)
    result = []
    result = calcWheelRamsey(coloringVector, n,m,degree,w1,w2)
    """
